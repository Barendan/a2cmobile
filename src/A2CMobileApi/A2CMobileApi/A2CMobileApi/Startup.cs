using A2CMobileApi.Infrastructure.Configs;
using A2CMobileApi.Infrastructure.Extensions;
...
namespace A2CMobileApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "A2CMobileApi ASP.NET Core API v1");
            });
