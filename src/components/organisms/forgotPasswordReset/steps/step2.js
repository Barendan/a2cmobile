...
const Step2 = ({ back, next, getState, saveState }) => {
    ...
    const [disableSecurityAnswerButton, setDisableSecurityAnswerButton] = React.useState(false);
    ...
    React.useEffect(() => {
        setDisableSecurityAnswerButton((securityAnswers.answerOne.length === 0
    ...
    React.useEffect(() => {
        ...
        if (memberRecord != null) {
            setPageLoaded(true);
            if (memberRecord.SecurityQuestionOne && memberRecord.SecurityQuestionTwo && memberRecord.SecurityQuestionThree) {
                ...
                {pageLoaded && <>
                    ...
                    {securityAnswersExist && memberRecord &&
                        <>
                            ...
                            <Input
                                style={styles.input}
                                onChangeText={text => updateSecurityAnswers('answerOne', text)}
                            ...
                            <Input
                                style={styles.input}
                                onChangeText={text => updateSecurityAnswers('answerTwo', text)}
                            ...
                            <Input
                                style={styles.input}
                                onChangeText={text => updateSecurityAnswers('answerThree', text)}
