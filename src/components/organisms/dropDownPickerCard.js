    ...
    return (
        <View>
            <TouchableHighlight onPress={() => setShowOptions(!showOptions)}>
                <Inset all={5} >
                    <Animated.View style={[styles.surface, props.showBorder && props.dashedBorder ? styles.dashedBorderStyle : styles.solidBorderStyle, viewHeight]}>
...
DropDownPickerCard.propTypes = {
     ...
     * CurrentCheckedValue
     */
    checkedValue: PropTypes.node.isRequired,
    /**
